    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          {/* Logo */}
          <Link to="/ar" className="flex items-center group">
            <motion.div
            ...
            <div className="me-3">
              ...
              <p className="text-xs text-gray-500 font-medium tracking-wide">نظام إدارة الأعمال</p>
            </div>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-4 space-x-reverse">
            ...
            >
              <span className="relative z-10">ابدأ تجربة مجانية</span>
              <motion.div
            ...
            >
              <div className="flex flex-col space-y-2 px-4">
                ...
                <Link 
                  to="/"
                  onClick={() => setMobileMenuOpen(false)}
                  className="px-4 py-3 rounded-xl font-medium text-gray-600 hover:bg-gray-50"
                >
                  English
                </Link>
